...
// utilizando o spread referenciando o array $bolo1 para pegar os valores de $bolo1 e adicionando o corante, 
// assim $bolo2 terá os mesmos itens de $bolo1 e adicionará o corante.
$bolo2 = [...$bolo1, 'corante'];

// Essa função exibe informação sobre uma variável de uma forma legível para humanos.
print_r($bolo2);

// Os itens serão adicionados conforme a ordem passada, no exemplo abaixo, 
// os itens de $bolo1 virão depois de água morna e antes de corante.
