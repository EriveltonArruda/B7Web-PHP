...
class Post {
  /* Criando as propriedades privadas, ou seja, 
  só poderão ser alteradas com encapsulamento (set) */
  private int $id;
  private int $likes = 0;
...
class Foto extends Post {
  ...
  /* Como eu tenho acesso ao $id que está dentro da classe Post que foi herdada pela classe Foto, 
  posso passar o $id no meu constructor, então toda vez que eu instanciar um objeto, 
  ele vai pegar a classe $id que está em Post e assim eu posso alterar o $id. */
...
/* Exibindo na tela o número do ID da foto (esse id está na classe Post, 
mas como foi herdado para Foto, tenho acesso pelo Objeto Foto (que foi criado pela classe Fotos), 
exibindo também a quantidade de likes e a URL que está dentro da classe Foto junto com as propriedades que estão na classe Post */
